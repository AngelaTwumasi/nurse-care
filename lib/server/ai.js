...
// contain the binary). Fall back to the real node_modules location.
function resolveFfmpeg() {
  if (ffmpegPathRaw && !ffmpegPathRaw.includes('.next')) return ffmpegPathRaw
...
export { callLLM, docsToParts, identifyPatients, generateNursingCare, transcribeAudio }
